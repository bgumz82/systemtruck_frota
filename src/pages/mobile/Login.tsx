...
export default function MobileLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Mobile login is only for operators, not admin
      if (email.trim() === 'bruno@systemtruck.com.br') {
        toast.error('Acesso administrativo não permitido na versão mobile')
        return
      }
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-sky-400 via-blue-900 to-gray-900">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center px-4">
        ...
        <div className="mt-8 w-full max-w-sm">
          ...
          <div className="mt-8 text-center text-sm text-blue-200/60">
            Versão Mobile • Desenvolvimento SYSTEMTRUCK
          </div>
        </div>
      </div>
    </div>
